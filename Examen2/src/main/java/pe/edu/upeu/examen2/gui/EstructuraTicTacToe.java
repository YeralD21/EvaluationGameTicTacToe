...
public class EstructuraTicTacToe {
    ...
    public void marcarCasilla(int i, int j, JLabel[][] casillas, DesignStartTicTacToe view) {
    ...
    private void terminarJuego(DesignStartTicTacToe view) {
        if (draw) {
            ResultadoTO to = view.uTO;
    ...
    void AnularGame(JLabel[][] casillas,DesignStartTicTacToe view) {
        turno = "X";
        end = false;
        draw = false;
        cantMovidas = 0;
