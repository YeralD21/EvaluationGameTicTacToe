 ...
 * @author HP
 */
public class DesignStartTicTacToe extends javax.swing.JFrame {
    ...
    public DesignStartTicTacToe() {
        ...
        //Icono
        try {
            image = ImageIO.read(obj.getFile("ggame.jpg"));
        } catch (Exception ex) {
    ...
    private void initComponents() {
        ...
        jButton2.setFont(new java.awt.Font("SF Slapstick Comic Shaded", 3, 24)); // NOI18N
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 360, 120, 40));

        jbtnExit.setBackground(new java.awt.Color(102, 0, 102));
        jbtnExit.setFont(new java.awt.Font("SF Slapstick Comic Shaded", 1, 48)); // NOI18N
        ...
        getContentPane().add(jbtnExit, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 110, 180, 80));
        ...
        getContentPane().add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 430, 180, -1));
        ...
        txtJugador1.setBackground(new java.awt.Color(102, 0, 102));
        ...
        txtJugador2.setBackground(new java.awt.Color(102, 0, 102));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name Party", "IdResult", "Player One", "Player Two", "Winner", "Puntuation", "Estate"
            }
        ) {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 230, 560, 330));

        btnIniciar.setBackground(new java.awt.Color(102, 0, 102));
        btnIniciar.setFont(new java.awt.Font("SF Slapstick Comic Shaded", 1, 24)); // NOI18N
        ...
        getContentPane().add(btnIniciar, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 360, 110, 40));

        btnAnular.setBackground(new java.awt.Color(102, 0, 102));
        btnAnular.setFont(new java.awt.Font("SF Slapstick Comic Shaded", 1, 24)); // NOI18N
        ...
        getContentPane().add(btnAnular, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 180, 150, 40));
        ...
        jLabel9.setPreferredSize(new java.awt.Dimension(1000, 1000));
